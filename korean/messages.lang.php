...
$l['error_nopermission_guest_1'] = '로그인하지 않았거나 이 페이지를 볼 수 있는 권한이 없습니다. 이는 다음과 같은 이유 중 하나 때문일 수 있습니다:';
$l['error_nopermission_guest_2'] = '로그인 또는 등록되지 않았습니다. 로그인 후 원하는 작업을 다시 시도하십시오.';
$l['error_nopermission_guest_3'] = '이 페이지에 액세스할 수 있는 권한이 없습니다. 관리 페이지에 액세스하려고 합니까, 아니면 안 되는 리소스에 액세스하려고 합니까? 이 작업을 수행할 수 있는 포럼 규칙을 확인하십시오.';
$l['error_nopermission_guest_4'] = '관리자가 계정을 비활성화했거나 계정 활성화를 기다리고 있을 수 있습니다.';
