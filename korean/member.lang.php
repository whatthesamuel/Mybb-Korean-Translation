...
// Last edited date : Mon, 19 Feb 2024 01:31:28 +0000
// --------------------------------------------------------------------------------
...
$l['agreement'] = '등록 계약';
$l['agreement_1'] = '부적절한, 성적 지향적인, 학대적인, 혐오스러운, 비방적인, 또는 다른 어떤 종류의 법에도 위배될 수 있는 위협적인 자료를 포함하는 모든 메시지를 편집하거나 제거하려고 시도하는 동안, 이 토론 시스템에 게시된 모든 메시지를 검토하는 것은 불가능합니다. 이러한 이유로 귀하는 이 토론 시스템에 게시된 모든 메시지가 반드시 이 게시판의 견해가 아니라 원래 메시지 작성자의 견해와 의견을 표현한다는 것을 인정합니다. 따라서 당사는 어떠한 책임도 지지 않으며 게시된 모든 메시지에 대해 책임을 질 수 없습니다. 당사는 모든 메시지의 정확성과 완전성을 보증하거나 보증하지 않습니다.';
$l['agreement_2'] = '이 토론 시스템에 등록함으로써 귀하는 고의로 허위, 부정확, 학대, 혐오, 괴롭힘, 성적 지향, 개인의 사생활에 대한 위협 또는 침습적인 자료 또는 관련 법을 위반할 수 있는 기타 자료를 게시하지 않을 것에 동의합니다.';
$l['agreement_3'] = '이러한 규칙을 준수하지 않으면 계정이 종료되거나 계정이 중단되거나 포럼에 대한 액세스가 영구적으로 금지될 수 있습니다. 귀하의 IP 주소는 이 토론 시스템에 작성한 각 게시물과 함께 기록되며 필요한 경우 포럼 직원이 검색할 수 있습니다. 귀하는 당사가 계정이나 메시지가 적합하다고 간주될 때 언제든지 제거, 편집 또는 잠금할 수 있다는 데 동의합니다. 또한 귀하는 이 토론 시스템에 입력한 모든 정보가 데이터베이스에 저장되고 로그인 정보를 저장하기 위해 컴퓨터에 "쿠키"가 저장된다는 데 동의합니다.';
$l['agreement_4'] = '귀하의 데이터가 손상된 해킹 시도에 대해 직원에게 책임을 물을 수는 없지만 이러한 포럼에서 제공하는 모든 정보는 귀하의 완전한 동의 없이 제3자에게 공개되지 않습니다.';
$l['agreement_5'] = '등록 프로세스를 계속 진행하면 위 규칙 및 관리자가 지정한 기타 모든 규칙에 동의하게 됩니다.';
